...
namespace MyPatientManager.Migrations
{
    ...
    [Migration("20240702115155_InitCreate")]
            ...
            modelBuilder.Entity("MyPatientManager.Model.Treatment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 7, 2, 13, 51, 55, 32, DateTimeKind.Local).AddTicks(700),
            ...
            modelBuilder.Entity("MyPatientManager.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Pw = "$2a$11$UAY4OhBMy08BNfxj7ZQEi.Kq.TAsn3x/QoR/78hPidX.XZprK9PIW",
                            Username = "johndoe"
                        });
                });
