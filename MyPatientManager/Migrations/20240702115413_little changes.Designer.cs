...
namespace MyPatientManager.Migrations
{
    ...
    [Migration("20240702115413_little changes")]
            ...
            modelBuilder.Entity("MyPatientManager.Model.Treatment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 7, 2, 13, 54, 13, 263, DateTimeKind.Local).AddTicks(4008),
            ...
            modelBuilder.Entity("MyPatientManager.Model.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Pw = "$2a$11$d9Mbyf/si0k1TVZ1d71mD.wXd5j/RP2RAwxynJ8vEn1c3P3XlgWeq",
                            Username = "johndoe"
                        });
                });
